...
public final class MenuSqlTemplate {
    ...
    public static String generate(ScaffoldModel model) {
        ...
        return "-- ============================================================\n"
            ...
            + "COMMIT;\n\n"
            + "-- 파일 배치 경로\n"
            + "-- src/main/java/com/example/sms/dto/" + module + "/" + cls + "SearchRequestDTO.java\n"
            + "-- src/main/java/com/example/sms/vo/" + module + "/" + cls + "VO.java\n"
            + "-- src/main/java/com/example/sms/mapper/" + module + "/" + cls + "Mapper.java\n"
            + "-- src/main/java/com/example/sms/service/" + module + "/" + cls + "Service.java\n"
            + "-- src/main/java/com/example/sms/controller/" + module + "/" + cls + "Controller.java\n"
            ...
            + "-- src/test/java/com/example/sms/service/" + module + "/" + cls + "ServiceTest.java\n"
            + "-- src/test/java/com/example/sms/controller/" + module + "/" + cls + "ControllerTest.java\n\n"
