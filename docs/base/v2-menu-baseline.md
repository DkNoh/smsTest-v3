...
v3 BASE PROJECT에서 static 메뉴와 DB seed가 공통으로 사용하는 v2 기준 메뉴 목록이다. 메뉴명이나 URL을 바꾸면 `StaticMenuProvider`, `db/oracle/02_menu_auth_seed.sql`, 이 문서를 함께 갱신한다.
...
- `src/main/java/com/example/sms/service/menu/StaticMenuProvider.java`
